...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["S", "M", "L", "XL"] }, { label: "Couleur", values: ["Rose", "Noir", "Blanc"] }],
  ...
  },
  {
    ...
    sizes: ["Unique"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["Unique"] }, { label: "Couleur", values: ["Doré", "Argenté", "Noir"] }],
  ...
  },
  {
    ...
    sizes: ["Unique"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["Unique"] }, { label: "Couleur", values: ["Rose", "Noir", "Beige"] }],
  ...
  },
  {
    ...
    sizes_label: "Taille",
    attributes: [{ label: "Pointure", values: ["36", "37", "38", "39", "40", "41", "42"] }, { label: "Couleur", values: ["Blanc", "Blanc/Rose"] }],
  ...
  },
  {
    ...
    sizes: ["XS", "S", "M", "L"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["XS", "S", "M", "L"] }, { label: "Couleur", values: ["Rose", "Blanc", "Noir"] }],
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["S", "M", "L", "XL"] }, { label: "Couleur", values: ["Rose", "Noir", "Bleu Marine"] }],
  ...
  },
  {
    ...
    sizes: ["M", "L", "XL", "XXL"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["M", "L", "XL", "XXL"] }, { label: "Couleur", values: ["Bleu Clair", "Bleu Foncé"] }],
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["S", "M", "L", "XL"] }, { label: "Couleur", values: ["Rose", "Gris", "Noir"] }],
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL", "XXL"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["S", "M", "L", "XL", "XXL"] }, { label: "Couleur", values: ["Blanc", "Noir", "Gris"] }],
  ...
  },
  {
    ...
    sizes_label: "Taille",
    attributes: [{ label: "Pointure", values: ["36", "37", "38", "39", "40"] }, { label: "Couleur", values: ["Nude", "Noir", "Rouge"] }],
  ...
  },
  {
    ...
    sizes: ["Unique"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["Unique"] }, { label: "Couleur", values: ["Doré", "Argenté"] }],
    colors: ["Doré", "Argenté"],
    is_flash_sale: true,
    is_best_seller: false,
    stock: 200,
  ...
  },
  {
    ...
    sizes: ["M", "L", "XL", "XXL"],
    sizes_label: "Taille",
    attributes: [{ label: "Taille", values: ["M", "L", "XL", "XXL"] }, { label: "Couleur", values: ["Kaki", "Noir", "Beige"] }],
