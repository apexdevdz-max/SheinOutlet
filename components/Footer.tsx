...
export function Footer() {
  return (
    <footer className="bg-gray-950 text-white pt-12 pb-6 md:pb-4 mb-16 md:mb-0" id="footer">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 pb-10 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                { label: "Accueil", href: "/" },
                { label: "Nouveautés", href: "/?filter=new" },
                { label: "Femme", href: "/?cat=femme" },
                { label: "Homme", href: "/?cat=homme" },
                { label: "Chaussures", href: "/?cat=chaussures" },
                { label: "Promotions", href: "/?filter=promo" },
              ].map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "213550000000"}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-[#25D366]/15 text-[#25D366] text-sm font-medium hover:bg-[#25D366]/25 transition-colors"
                >
        ...
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-500">
          <p>© {new Date().getFullYear()} SHEIN Outlet Algérie. Tous droits réservés.</p>
